...
import { faBooks, faBookMedical, faFileCirclePlus } from '@awesome.me/kit-3d36d6b3e3/icons/duotone/solid'
...
export function Navigation() {
  ...
  return (
    <nav className={classes.root}>
      <NavLink to="/library" title="Cookbook Library" className={classes.navLink}>
